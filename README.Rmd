...
This paackage provides the code used in Fabre et al 2020 to calculate per-landmark rate and variance
...
The log10-transformed rate and variance can be plotted on surfaces using the rgl and Rvcg packages
